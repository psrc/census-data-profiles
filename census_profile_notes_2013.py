...
all_profile_notes = ['Notes applicable to all Census Data Profiles:',
					 ...
					 '',
					 'In data year 2013, there were a series of changes to data collection operations that could have affected some estimates. These changes include the addition of Internet as a mode '+
					 'of data collection, the end of the content portion of Failed Edit Follow-Up interviewing, and the loss of one monthly panel due to the Federal Government shut down in October 2013. '+
...
dp02_notes = ['Notes for DP02: SELECTED SOCIAL CHARACTERISTICS IN THE UNITED STATES',
              ...
              '',
              'Due to methodological changes to data collection that began in data year 2013, comparisons of language estimates from that point to estimates from 2013 '+
			  'forward should be made with caution. For more information, see: : http://www.census.gov/acs/www/data_documentation/user_notes/',
              '',
              ...
              '',
              'The category "with a broadband Internet subscription" refers to those who said "Yes" to a DSL, cable, fiberoptic, mobile broadband, satellite, or fixed wireless subscription.',
			'']
